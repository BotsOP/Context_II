...
public class PathCreator : MonoBehaviour
{
    ...
    [SerializeField] private float pointSpawnDistance = 1;
    ...
    public void AddSegment()
    {
        ...
        Vector3 localScale = transform.localScale;
        Transform point1 = Instantiate(original, lastPos + (Vector3.left + Vector3.forward) * (0.5f * 2 * localScale.x * pointSpawnDistance), quaternion.identity, transformList[^1]).transform;
        Transform point3 = Instantiate(original, lastPos + Vector3.right * (2 * localScale.x * pointSpawnDistance), quaternion.identity, transform).transform;
        Transform point2 = Instantiate(original, lastPos + (Vector3.right + Vector3.forward) * (0.5f * 2 * localScale.x * pointSpawnDistance), quaternion.identity, point3).transform;
